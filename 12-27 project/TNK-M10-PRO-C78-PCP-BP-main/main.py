...
def eval_fitness(generation, config):
    ...
    for gid, genome in generation: 
        ...
        NuNet = neat.nn.FeedForwardNetwork.create(genome, config)
...
config = neat.config.Config(neat.DefaultGenome, neat.DefaultReproduction, neat.DefaultSpeciesSet, neat.DefaultStagnation, 'C:/Users/Ahyoung/Downloads/12-27 project/TNK-M10-PRO-C78-PCP-BP-main/config-feedforward.txt')
